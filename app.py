...
# --- DATABASE SOAL LOKAL LENGKAP (BAB 9) ---
if "database_soal" not in st.session_state:
    st.session_state.database_soal = [
        ...
        },
        {
            ...
            "hiragana": "ぼく の そば に ずっと いて ほしい 。 とおく へ いかないde ほしい 。",
        ...
        },
        {
            ...
            "hiragana": "この むら の しぜん かんきょう を これ いじょう こわさないde ほしい 。",
        ...
        },
        {
            ...
            "kunci": ["さっき", "同じ", "ことを", "何度も", "説明したよ", "。それ", "以上は", "言わせないでもらいたい", "だよ。"]
        },
        {
            "id": 11,
            "pola": "Bagian 2: ～(さ)せてもらいたい・～(さ)せてほしい (Memohon izin melakukan sesuatu)",
        ...
        },
        {
            ...
            "kunci": ["最近ずっと", "体の調子が", "悪い。", "悪い病気", "でなければいい", "ag。"]
        },
        {
            "id": 15,
            "pola": "Bagian 3: ～といい・～ばいい・～たらいい (A: Harapan / Keinginan Situasi Baik)",
        ...
        },
        {
            "id": 17,
            "pola": "Bagian 3: ～といい・～ばいい・～たらいい (B: Saran / Rekomendasi Ringan)",
            "kanji": "その job、気が進mないのなら引き受けなければいいんじゃないですか。",
        ...
        },
        {
            ...
            "kunci": ["申込書の", "書き方が", "わからなければ", "、事務の人", "に聞いてみたらいい", "ですよ", "。"]
        }
    ]
...
# --- CSS PREMIUM HORIZONTAL LOOK (DUOLINGO STYLE) ---
st.markdown("""
<style>
    /* Info Box */
    .info-box {
    ...
    /* KONTEN UTAMA: Pengunci Horizontal Total (Bisa di-scroll ke samping kanan-kiri) */
    .flex-papan-jepang {
        display: flex !important;
        flex-direction: row !important;
        flex-wrap: nowrap !important; /* Mematikan bungkus otomatis ke bawah */
    ...
    /* Sembunyikan scrollbar bawaan agar estetika tombol bersih */
    .flex-papan-jepang::-webkit-scrollbar {
        height: 4px;
    }
    .flex-papan-jepang::-webkit-scrollbar-thumb {
    ...
    /* PREMIUM 3D BUTTON KAPSUL (HORIZONTALLY LOCKED) */
    .tombol-kata-inline {
        ...
        white-space: nowrap !important; /* Melarang teks terpotong vertikal */
        flex-shrink: 0 !important; /* Menolak tombol mengkerut demi muat layar */
...
if not st.session_state.jawaban_user:
    html_papan_user += "<span style='color:#adb5bd; font-style:italic; font-weight:600; white-space: nowrap;'>Ketuk kata di bawah untuk mulai menyusun...</span>"
else:
...
st.markdown("<div class='label-section'>Pilihan Kata (Geser ke samping jika panjang):</div>", unsafe_allow_html=True)
